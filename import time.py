...
# Inicializar un punto para el TAG
...
# Posición anterior del TAG
posicion_anterior = (0, 0, 0)
...
while True:
    ...
    if np.isfinite(posicion[0]) and np.isfinite(posicion[1]) and np.isfinite(posicion[2]):
        # Comparar la nueva posición con la anterior
