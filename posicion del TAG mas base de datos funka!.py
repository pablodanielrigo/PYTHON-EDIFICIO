...
csv_file = 'coordenadas_tag.csv'
with open(csv_file, mode='w', newline='') as file:
    writer = csv.writer(file)
    writer.writerow(['Fecha', 'Hora', 'X', 'Y', 'Z', 'Tag'])
        ...
        if linea:
            ...
            try:
                ...
                if len(coordenadas) == 3:
                    ...
                    # Actualizar el gráfico con la nueva posición
                    ...
                    # Escribir las coordenadas y la palabra "TAG1" en el archivo CSV
                    with open(csv_file, mode='a', newline='') as file:
                        writer = csv.writer(file)
                        writer.writerow([fecha, hora, *posicion_tag, 'TAG1'])
            except ValueError:
